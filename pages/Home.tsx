...
const FormError = <p data-automation-id="form-error-message" className="mt-2 text-red-500">This field is required.</p>
    ...
    <div data-automation-id="home" className={`${styles.container} bg-slate-100 rounded-lg p-6`}>
      ...
      <form data-automation-id="form-nft-projects" className="space-y-4" onSubmit={onFormSubmit}>
        <section data-automation-id="section-content">
          <div data-automation-id="fieldset-projects">
          ...
          <div data-automation-id="fieldset-quantity">
