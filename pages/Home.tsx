...
const FormError = <p data-automation-id="form-error-message" className="text-red-500">This field is required.</p>

const Home = (props: HomeProps) => {
  const { quantity, project, result, errors, onFormSubmit, onProjectSelectChange, onQuantityChange, onResetClick } = props;

  return (
    <div data-automation-id="home" className="max-w-screen-lg my-10 mx-auto bg-slate-100 rounded-lg p-6">
        ...
        <form data-automation-id="form-nft-projects" className="space-y-4" onSubmit={onFormSubmit}>
          <section data-automation-id="section-content">
            <div data-automation-id="fieldset-projects" className="mb-4">
              <label htmlFor="projects" className="block mb-2">Choose project:</label>
            ...
            <div data-automation-id="fieldset-quantity" className="mb-4">
              <label htmlFor="quantity" className="block mb-2">How many items you want to buy?</label>
              <input
          ...
          <footer data-automation-id="footer">
            <button data-automation-id="button-submit" type="submit" className="border border-green-300 bg-green-300 pl-2 pr-2 py-1 rounded font-medium">
              Submit
            </button>
            <button
