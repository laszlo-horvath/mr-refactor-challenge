...
const Nft = (props: NftProps) => {
  ...
  return (
    <div
      key={nft.id}
      className="flex-1 relative text-center max-w-[24%] my-2 mr-2 border-4 border-indigo-800 rounded-lg p-3 transition-all hover:drop-shadow-xl hover:scale-110 bg-indigo-700 hover:bg-indigo-600 hover:z-50"
    >
      {index !== undefined && (
