...
export default function EthPrices() {
  ...
  return (
    <div className="flex sm:justify-center justify-end text-white">
      ...
      <Counter from={prevEthPrice.EUR} to={currentEthPrice.EUR} currency={'EUR'} />
      <Counter from={prevEthPrice.GBP} to={currentEthPrice.GBP} currency={'GBP'} />
    </div>
  );
}
